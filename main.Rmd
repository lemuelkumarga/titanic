...
2. 20% Testing Group: The accuracy when used to predict the remaining 20% of the data not used in calibration,
3. Kaggle's Testing Set: The accuracy when used to predict the test set provided by Kaggle.
